...
<Steps>
  ...
  <Step title="Connect the API">
    Ask your platform administrator for a Bearer token — tokens are issued from the central admin, not your own — then start making calls to `/api/v1/posts` from your own apps.
  </Step>
</Steps>
...
<CardGroup cols={2}>
  ...
  <Card title="Block Page Editor" icon="table-cells" href="/content/pages">
    Build rich landing pages from reusable blocks: hero images, CTAs, two-column layouts, accordions, video and audio, custom HTML embeds, and more.
  </Card>
