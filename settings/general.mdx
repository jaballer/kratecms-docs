...
<Note>
  Business Info is always available in the admin — it is not gated behind any feature flag. If you have a [Krate page](/content/krate-page), use the display toggles there (**Show contact email**, **Show contact phone number**, **Show business hours**, **Show business address**) to control which details appear publicly. Your business name and address also appear in transactional email footers regardless of the Krate page setting.
</Note>
