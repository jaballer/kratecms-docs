...
<Note>
**Future-state guidance.** The Billing section is off platform-wide during the KrateCMS alpha and cannot be enabled for an individual site, so you won't find it in your admin settings yet. This page describes how the Stripe integration works once billing ships.
</Note>
...
<Steps>
  ...
  <Step title="Verify your billing settings in KrateCMS">
    Once billing ships, you'll confirm the integration at `/admin/settings/billing` in your KrateCMS admin panel and link to the customer portal from there for testing. That page isn't available yet — see the note at the top of this guide.
  </Step>
</Steps>
